...
export type TokenDayDocument = TokenDay & Document;
...
export const TokenDaySchema = SchemaFactory.createForClass(TokenDay);

// Unique index for token + date
TokenDaySchema.index({ tokenAddress: 1, date: 1 }, { unique: true });
